# run_vtbs_comparison.ps1
# This script automates the noise analysis for VTBS (Suvarnabhumi) airport
...
Write-Host "   Starting Automated VTBS Noise Analysis & Comparison" -ForegroundColor Cyan
Write-Host "====================================================" -ForegroundColor Cyan
...
.\venv\Scripts\python compare_plots.py -ap $airport -m dbscan -er "100,500"

Write-Host ">>> Comparing MSA variations..." -ForegroundColor Gray
.\venv\Scripts\python compare_plots.py -ap $airport -m msa -br "100,500"

# 4. Cross-model comparison
Write-Host "`n[4/4] Generating Cross-Model Comparison (MSA vs DBSCAN)..." -ForegroundColor Yellow
.\venv\Scripts\python compare_plots.py -ap $airport -m msa_dbscan -br "100,500" -er "100,500"
